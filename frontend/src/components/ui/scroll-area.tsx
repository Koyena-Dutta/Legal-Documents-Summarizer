...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "flex touch-none p-px transition-colors select-none bg-slate-200/70 hover:bg-slate-300/80 rounded",
        orientation === "vertical" &&
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="bg-slate-500/90 relative flex-1 rounded-full"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  )
}
